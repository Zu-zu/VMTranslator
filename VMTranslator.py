...
def writePushPop(command,segment,index,line,outputfile):
    if command == "PUSH" and segment == "constant":
        ...
        f.write("M=D\n")
        f.close()
    elif command == "POP" and segment == "R5":
        f = open(outputfile,'a')
        f.write("//"+line)
        f.write("@"+segment+"\n")
        f.write("D=A"+"\n")
        ...
        f.write("M=D"+"\n")
        f.close()
    elif command =="PUSH" and segment == "R5":
        f = open(outputfile,'a')
        f.write("//"+line)
        f.write("@"+segment+"\n")
        f.write("D=A"+"\n")
...
def writeArithmetic(segment,line,count,outputfile):
    if segment == "ADD":
        ...
        f.write("A = A+1\n")
        f.write('D=D-M\n')
        f.write("@ifTrue"+str(count)+"\n")
        f.write("D;JEQ\n")
        f.write("@ifFalse"+str(count)+"\n")
        f.write("0;JMP\n")
        f.write("(ifTrue"+str(count)+")\n")
        f.write("@SP\n")
        f.write("M=M-1\n")
